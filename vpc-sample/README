...
`gcloud functions deploy restricted-function --runtime=python38 --trigger-http \
--no-allow-unauthenticated --ingress-settings=internal-only --entry-point=hello_world`
